...
const FeatureSection = () => {
  ...
  return (
    <section className="relative text-white py-12 sm:py-16 bg-gradient-to-b from-orange-500 to-red-700">
      <div className="container mx-auto px-4 sm:px-8">

        {/* Counter Section */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center border-b border-white border-opacity-25 pb-6 sm:pb-8">
          ...
          {[
            ...
            <div key={idx} className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform transform hover:scale-105">
              ...
              <div className="p-4 sm:p-6 text-center">
                ...
                <a href={course.link} className="inline-block bg-orange-500 text-white px-4 sm:px-6 py-2 rounded-full hover:bg-orange-600 transition duration-300">View Program</a>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Other <span className="text-pink-500">Courses</span></h2>
